...
switch ($action) {
	case 'ArticleMng':
		...
		break;
	case 'CateArticleMng':
		$f='Admin_CateArticleMng';
		$blogtitle=$lang['msg']['catearticle_manage'];
		break;
	case 'PageMng':
		$f='Admin_PageMng';
		$blogtitle=$lang['msg']['page_manage'];
		break;
	case 'CategoryMng':		//二级分类管理
		$f='Admin_CategoryMng';
		$blogtitle=$lang['msg']['category_manage'];
		break;
	case 'TopCategoryMng':	//一级分类管理
		$f='Admin_TopCategoryMng';
		$blogtitle=$lang['msg']['top_category_manage'];
		break;		
	case 'CommentMng':
		$f='Admin_CommentMng';
