...
'TopCategory'=>array(
		'ID'=>array('topcate_ID','integer','',0),
		'Name'=>array('topcate_Name','string',50,''),
		'Order'=>array('topcate_Order','integer','',0),
		'Count'=>array('topcate_Count','integer','',0),
),
'Comment'=> array(
