					...
					<div id="label">
						...
						foreach ($tags as $key => $value)
						{
							...
							<div class="label-background label-left">
								<a href="./showPaperList.php?type=cate&<?php echo 'cate_ID='.$value['cate_ID'];?>"><?php echo  $value['cate_Name'];?></a>
							</div>
							<?php 
						}
						?>
						...
						<div class="clearfix">
						 <?php
							foreach ($members as $key => $value)
							{
								...
								<div class="label-background label-left">
								<a href="./showPaperList.php?type=author&<?php echo 'mem_ID='.$value['mem_ID'];?>"><?php echo $value['mem_Name'];?></a>
							</div>
								<?php 
