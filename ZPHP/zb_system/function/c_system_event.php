...
function PostArticle() {
	...
	$log_ID = $data['log_ID'];
	//echo "My Log_ID:".$log_id['log_ID']."<br>";
	/*
...
// 	//echo "My name:".$name;	
// 	{
// 		$testSQL = "SELECT * FROM zbp_addtopost where log_ID ='$log_ID'";
// 		$data = $zbp->db->Query($testSQL);
// 		if(!$data)
// 		{
// 			$insertSQL = "INSERT INTO zbp_addtopost(log_ID, keywords, authorname) VALUES ('$log_ID', '$keywords', '$name')";
// 			$zbp->db->Insert($insertSQL);
// 		}else{
// 			$update = "UPDATE zbp_addtopost SET keywords = '$keywords', authorname='$name'";
// 			$zbp->db->Update($update);
// 		}
// 	}
...
// 		echo "Have data";
		$updateSQL = "UPDATE $table SET abstract = 'j', keywords = '$keywords', titleImage = '$fullPath' WHERE log_ID = '$log_ID'";
// 		echo $updateSQL;
